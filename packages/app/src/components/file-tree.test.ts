...
beforeAll(async () => {
  ...
  mock.module("@opencoder-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@opencoder-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@opencoder-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@opencoder-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
