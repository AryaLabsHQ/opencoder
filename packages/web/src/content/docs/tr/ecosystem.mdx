...
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | @opencoder-ai/sdk aracılığıyla opencode'u kullanmak için Vercel AI SDK sağlayıcısı |
